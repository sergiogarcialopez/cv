...
function drawChart() {
    ...
    dataTable.addRows([
        ...
        ['11', 'Inglés Básico', new Date(2006, 0, 1), new Date(2009, 11, 1)],
        ...
        ['4', 'Certificación MS Office PowerPoint 2010', new Date(2016, 0, 1), new Date(2016, 11, 1)],
        ['5', 'Certificación DELF A1', new Date(2017, 0, 1), new Date(2017, 11, 1)],
        ['6', 'Técnico en Sist. comp. y desarr. de soft.', new Date(2018, 0, 1), new Date(2018, 11, 1)],
